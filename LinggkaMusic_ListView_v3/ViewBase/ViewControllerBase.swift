...
class ViewControllerBase: UIViewController {
    ...
    var listView = ListView(frame: CGRect(x: 0, y: 0, width: 0, height: 0), style: .plain)
    ...
    var listViewOrder = { (_ controller: ViewControllerBase) in
        
        controller.listView.items = controller.itemsOfListView
        controller.view.addSubview(controller.listView)
        controller.listView.translatesAutoresizingMaskIntoConstraints = false
        let cn1 = NSLayoutConstraint(item: controller.listView, attribute: .centerX, relatedBy: .equal, toItem: controller.btn_Title ,attribute: .centerX, multiplier: 1.0, constant: 0)
        let cn2 = NSLayoutConstraint(item: controller.listView, attribute: .top, relatedBy: .equal, toItem: controller.btn_Title, attribute: .bottom, multiplier: 1.0, constant: 0)
        let cn3 = NSLayoutConstraint(item: controller.listView, attribute: .height, relatedBy: .greaterThanOrEqual , toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: CGFloat(controller.itemsOfListView.count)*50)
        let cn4 = NSLayoutConstraint(item: controller.listView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 200)
        NSLayoutConstraint.activate([cn1, cn2, cn3, cn4])
