...
class ViewSongs: ViewControllerTableBase {
    ...
    // Items For ListView
    var itemsForListView = { (_ controller: ViewSongs) in
    
        controller.itemsOfListView = [Label(displayName: "Name", id: 1, column: "SongName"), Label(displayName: "ID", id: 2, column: "ID")]
